...
using Xunit;
using FileMode = LiteDB.ConnectionType;
...
namespace Stratis.Bitcoin.Features.BlockStore.Tests
{
    public class AddressIndexerTests
    {
        ...
        public void OutPointCacheCanRetrieveExisting()
        {
            ...
            FileMode fileMode = RuntimeInformation.IsOSPlatform(OSPlatform.OSX) ? FileMode.Direct : FileMode.Shared;

            var database = new LiteDatabase(new ConnectionString() { Filename = dbPath, Connection = fileMode });
